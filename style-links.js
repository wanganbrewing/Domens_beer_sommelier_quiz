(() => {
  ...
  const STYLE_GROUPS = [
    ...
    [["インターナショナル・ペールラガー", "ジャパニーズ・ドライラガー", "ジャパニーズドライ"], "2/2A/international-pale-lager"],
    ...
    [["チェコ・ダークラガー", "チェコダーク"], "3/3D/czech-dark-lager"],
    ...
    [["ヘーフェヴァイツェン", "クリスタルヴァイツェン", "ヴァイスビア", "ヴァイツェン"], "10/10A/weissbier"],
    [["デュンケルヴァイツェン", "ドゥンケルヴァイツェン", "ダークヴァイツェン"], "10/10B/dunkles-weissbier"],
    [["ヴァイツェンボック"], "10/10C/weizenbock"],
    [["オーディナリービター"], "11/11A/ordinary-bitter"],
    [["ベストビター"], "11/11B/best-bitter"],
    [["ストロングビター", "ビター/ESB", "ESB"], "11/11C/strong-bitter"],
    [["イングリッシュペールエール"], "11/british-bitter"],
    [["ブリティッシュ・ゴールデンエール"], "12/12A/british-golden-ale"],
    [["オーストラリアン・スパークリングエール", "スパークリングエール"], "12/12B/australian-sparkling-ale"],
    [["イングリッシュIPA"], "12/12C/english-ipa"],
    [["ダークマイルド"], "13/13A/dark-mild"],
    [["ブリティッシュ・ブラウンエール", "イングリッシュ・ブラウンエール", "イングリッシュブラウン"], "13/13B/british-brown-ale"],
    [["ロンドン・ポーター", "ロンドンポーター", "イングリッシュポーター"], "13/13C/english-porter"],
    [["スコティッシュ・エクスポート"], "14/14C/scottish-export"],
    [["アイリッシュ・レッドエール"], "15/15A/irish-red-ale"],
    [["アイリッシュ・ドライスタウト", "アイリッシュドライスタウト", "ドライスタウト"], "15/15B/irish-stout"],
    ...
    [["ウィーヘビー", "スコッチエール"], "17/17C/wee-heavy"],
    [["イングリッシュ・バーレイワイン", "イングリッシュバーレイワイン"], "17/17D/english-barley-wine"],
    ...
    [["アメリカン・バーレイワイン", "アメリカンバーレイワイン"], "22/22C/american-barleywine"],
    [["ベルリナーヴァイセ"], "23/23A/berliner-weisse"],
    [["フランダース・レッドエール", "フランダースレッド"], "23/23B/flanders-red-ale"],
    ...
    [["トラピスト・ダブル", "ベルジャン・デュッベル", "デュッベル", "ダブル"], "26/26B/belgian-dubbel"],
    ...
    [["グレープエール（旧称イタリアングレープエール）", "イタリアングレープエール", "IGA"], "29/29D/grape-ale"],
    [["ニュージーランドIPA", "NZ IPA"], "21/ipa"],
  ];
